...
class Box extends Component {
    ...
    constructor(props) {
        ...
        // this.myConfig.echartDefault.tooltip.formatter = "{a}<br/>{b}年 : {c} " + "人";
        this.myConfig.echartDefault.tooltip.trigger = 'axis';
        this.myConfig.echartDefault.tooltip.axisPointer = { // 坐标轴指示器，坐标轴触发有效
